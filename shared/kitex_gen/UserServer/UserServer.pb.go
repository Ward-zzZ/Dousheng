...
//MGet User info
type DouyinMUserRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DouyinMUserRequest) Reset() {
	*x = DouyinMUserRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *DouyinMUserRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DouyinMUserRequest) ProtoMessage() {}

func (x *DouyinMUserRequest) ProtoReflect() protoreflect.Message {
	mi := &file_UserServer_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DouyinMUserRequest.ProtoReflect.Descriptor instead.
func (*DouyinMUserRequest) Descriptor() ([]byte, []int) {
	return file_UserServer_proto_rawDescGZIP(), []int{8}
}

func (x *DouyinMUserRequest) GetUserId() []int64 {
	if x != nil {
		return x.UserId
	}
	return nil
...
type DouyinMUserResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	BaseResp *BaseResp `protobuf:"bytes,1,opt,name=base_resp,json=baseResp,proto3" json:"base_resp,omitempty"`
	User     []*User   `protobuf:"bytes,2,rep,name=user,proto3" json:"user,omitempty"` // 用户信息
}

func (x *DouyinMUserResponse) Reset() {
	*x = DouyinMUserResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *DouyinMUserResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DouyinMUserResponse) ProtoMessage() {}

func (x *DouyinMUserResponse) ProtoReflect() protoreflect.Message {
	mi := &file_UserServer_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DouyinMUserResponse.ProtoReflect.Descriptor instead.
func (*DouyinMUserResponse) Descriptor() ([]byte, []int) {
	return file_UserServer_proto_rawDescGZIP(), []int{9}
}

func (x *DouyinMUserResponse) GetBaseResp() *BaseResp {
	if x != nil {
		return x.BaseResp
	}
	return nil
...
func (x *DouyinMUserResponse) GetUser() []*User {
	if x != nil {
		return x.User
	}
	return nil
...
// Change User follow
type DouyinChangeUserFollowRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	UserId   int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`         // 关注用户id
	ToUserId int64 `protobuf:"varint,2,opt,name=to_user_id,json=toUserId,proto3" json:"to_user_id,omitempty"` // 被关注用户id
	IsFollow bool  `protobuf:"varint,3,opt,name=is_follow,json=isFollow,proto3" json:"is_follow,omitempty"`   //是关注还是取关
}

func (x *DouyinChangeUserFollowRequest) Reset() {
	*x = DouyinChangeUserFollowRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *DouyinChangeUserFollowRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DouyinChangeUserFollowRequest) ProtoMessage() {}

func (x *DouyinChangeUserFollowRequest) ProtoReflect() protoreflect.Message {
	mi := &file_UserServer_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DouyinChangeUserFollowRequest.ProtoReflect.Descriptor instead.
func (*DouyinChangeUserFollowRequest) Descriptor() ([]byte, []int) {
	return file_UserServer_proto_rawDescGZIP(), []int{10}
}

func (x *DouyinChangeUserFollowRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *DouyinChangeUserFollowRequest) GetToUserId() int64 {
	if x != nil {
		return x.ToUserId
	}
	return 0
...
func (x *DouyinChangeUserFollowRequest) GetIsFollow() bool {
	if x != nil {
		return x.IsFollow
	}
	return false
...
var file_UserServer_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x0a, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x22, 0x74,
	...
	0x6f, 0x75, 0x6e, 0x74, 0x22, 0x4a, 0x0a, 0x08, 0x42, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70,
	...
	0x22, 0x53, 0x0a, 0x19, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65,
	...
	0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x68, 0x0a, 0x1a, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x55,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72,
	...
	0x50, 0x0a, 0x16, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x6f, 0x67,
	...
	0x64, 0x22, 0x65, 0x0a, 0x17, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x55, 0x73, 0x65, 0x72, 0x4c,
	0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x31, 0x0a, 0x09,
	...
	0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x2c, 0x0a, 0x11, 0x44, 0x6f, 0x75, 0x79,
	0x69, 0x6e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x17, 0x0a,
	0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06,
	0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x6d, 0x0a, 0x12, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e,
	...
	0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x2d, 0x0a, 0x12, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x4d,
	...
	,
	...
	,
	...
	0x22, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x44, 0x6f, 0x75,
	0x79, 0x69, 0x6e, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x23, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72,
	...
	,
...
var file_UserServer_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_UserServer_proto_goTypes = []interface{}{
	...
	(*DouyinMUserRequest)(nil),            // 8: UserServer.DouyinMUserRequest
	(*DouyinMUserResponse)(nil),           // 9: UserServer.DouyinMUserResponse
	(*DouyinChangeUserFollowRequest)(nil), // 10: UserServer.DouyinChangeUserFollowRequest
}
var file_UserServer_proto_depIdxs = []int32{
	...
	1,  // 4: UserServer.DouyinMUserResponse.base_resp:type_name -> UserServer.BaseResp
	0,  // 5: UserServer.DouyinMUserResponse.user:type_name -> UserServer.User
	2,  // 6: UserServer.UserService.Register:input_type -> UserServer.DouyinUserRegisterRequest
	4,  // 7: UserServer.UserService.Login:input_type -> UserServer.DouyinUserLoginRequest
	6,  // 8: UserServer.UserService.GetUserInfo:input_type -> UserServer.DouyinUserRequest
	8,  // 9: UserServer.UserService.MGetUserInfo:input_type -> UserServer.DouyinMUserRequest
	10, // 10: UserServer.UserService.ChangeUserFollowCount:input_type -> UserServer.DouyinChangeUserFollowRequest
	3,  // 11: UserServer.UserService.Register:output_type -> UserServer.DouyinUserRegisterResponse
	5,  // 12: UserServer.UserService.Login:output_type -> UserServer.DouyinUserLoginResponse
	7,  // 13: UserServer.UserService.GetUserInfo:output_type -> UserServer.DouyinUserResponse
	9,  // 14: UserServer.UserService.MGetUserInfo:output_type -> UserServer.DouyinMUserResponse
	1,  // 15: UserServer.UserService.ChangeUserFollowCount:output_type -> UserServer.BaseResp
...
func file_UserServer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_UserServer_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DouyinMUserRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_UserServer_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DouyinMUserResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_UserServer_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DouyinChangeUserFollowRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type UserService interface {
	...
	MGetUserInfo(ctx context.Context, req *DouyinMUserRequest) (res *DouyinMUserResponse, err error)
	ChangeUserFollowCount(ctx context.Context, req *DouyinChangeUserFollowRequest) (res *BaseResp, err error)
}
