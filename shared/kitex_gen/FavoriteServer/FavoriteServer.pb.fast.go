...
func (x *User) fastWriteField6(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt64(buf[offset:], 6, x.GetTotalBeFavorite())
	return offset
}
...
func (x *User) fastWriteField7(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt64(buf[offset:], 7, x.GetFavoriteCount())
	return offset
}
...
func (x *DouyinUserBeFavoriteResponse) fastWriteField2(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt64(buf[offset:], 2, x.GetTotalBeFavorite())
	return offset
}
...
func (x *DouyinVideoBeFavoriteResponse) fastWriteField2(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt64(buf[offset:], 2, x.GetFavoriteCount())
	return offset
}
...
func (x *DouyinQueryFavoriteResponse) fastWriteField2(buf []byte) (offset int) {
	...
	offset += fastpb.WriteBool(buf[offset:], 2, x.GetFavorite())
	return offset
}
...
func (x *User) sizeField6() (n int) {
	...
	n += fastpb.SizeInt64(6, x.GetTotalBeFavorite())
	return n
}
...
func (x *User) sizeField7() (n int) {
	...
	n += fastpb.SizeInt64(7, x.GetFavoriteCount())
	return n
}
...
func (x *DouyinUserBeFavoriteResponse) sizeField2() (n int) {
	...
	n += fastpb.SizeInt64(2, x.GetTotalBeFavorite())
	return n
}
...
func (x *DouyinVideoBeFavoriteResponse) sizeField2() (n int) {
	...
	n += fastpb.SizeInt64(2, x.GetFavoriteCount())
	return n
}
...
func (x *DouyinQueryFavoriteResponse) sizeField2() (n int) {
	...
	n += fastpb.SizeBool(2, x.GetFavorite())
	return n
}
