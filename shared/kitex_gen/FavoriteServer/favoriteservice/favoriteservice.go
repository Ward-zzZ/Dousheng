...
func (p *GetFavoriteUserArgs) GetFirstArgument() interface{} {
	return p.Req
}
...
func (p *GetFavoriteUserResult) GetResult() interface{} {
	return p.Success
}
...
func (p *GetFavoriteVideoArgs) GetFirstArgument() interface{} {
	return p.Req
}
...
func (p *GetFavoriteVideoResult) GetResult() interface{} {
	return p.Success
}
...
func (p *QueryUserLikeVideoArgs) GetFirstArgument() interface{} {
	return p.Req
}
...
func (p *QueryUserLikeVideoResult) GetResult() interface{} {
	return p.Success
}
