...
func (p *MGetRelationFollowListArgs) GetFirstArgument() interface{} {
	return p.Req
}
...
func (p *MGetRelationFollowListResult) GetResult() interface{} {
	return p.Success
}
...
func (p *MGetUserRelationFollowerListArgs) GetFirstArgument() interface{} {
	return p.Req
}
...
func (p *MGetUserRelationFollowerListResult) GetResult() interface{} {
	return p.Success
}
