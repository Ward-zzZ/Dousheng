...
func (x *FriendUser) fastWriteField6(buf []byte) (offset int) {
	...
	offset += fastpb.WriteString(buf[offset:], 6, x.GetMessage())
	return offset
}
...
func (x *FriendUser) fastWriteField7(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt64(buf[offset:], 7, x.GetMsgType())
	return offset
}
...
func (x *FriendUser) sizeField6() (n int) {
	...
	n += fastpb.SizeString(6, x.GetMessage())
	return n
}
...
func (x *FriendUser) sizeField7() (n int) {
	...
	n += fastpb.SizeInt64(7, x.GetMsgType())
	return n
}
