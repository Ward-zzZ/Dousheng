...
func (p *kVideoSrvClient) Feed(ctx context.Context, Req *VideoServer.DouyinFeedRequest, callOptions ...callopt.Option) (r *VideoServer.DouyinFeedResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.Feed(ctx, Req)
}

func (p *kVideoSrvClient) PublishAction(ctx context.Context, Req *VideoServer.DouyinPublishActionRequest, callOptions ...callopt.Option) (r *VideoServer.DouyinPublishActionResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
