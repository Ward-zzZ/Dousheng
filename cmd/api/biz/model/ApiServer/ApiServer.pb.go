...
import (
	...
	reflect "reflect"
	sync "sync"
	_ "tiktok-demo/cmd/api/biz/model/api"
)
...
type FriendUser struct {
	...
	FollowerCount int64  `protobuf:"varint,4,opt,name=follower_count,json=followerCount,proto3" json:"follower_count,omitempty" form:"follower_count" query:"follower_count"` // 粉丝总数--可选
	IsFollow      bool   `protobuf:"varint,5,opt,name=is_follow,json=isFollow,proto3" json:"is_follow,omitempty" form:"is_follow" query:"is_follow"`                          // true-已关注，false-未关注
	Message       string `protobuf:"bytes,6,opt,name=message,proto3" json:"message,omitempty" form:"message" query:"message"`                                                 // 最新聊天消息
	MsgType       int64  `protobuf:"varint,7,opt,name=msgType,proto3" json:"msgType,omitempty" form:"msgType" query:"msgType"`                                                // 0 => 当前请求用户接收的消息， 1 => 当前请求用户发送的消息
}
...
type DouyinFeedResponse struct {
	...
	VideoList []*Video  `protobuf:"bytes,2,rep,name=video_list,json=videoList,proto3" json:"video_list,omitempty" form:"video_list" query:"video_list"` // 视频列表--注意按照投稿时间戳逆序返回视频列表
...
type DouyinPublishListResponse struct {
	...
	BaseResp  *BaseResp `protobuf:"bytes,1,opt,name=base_resp,json=baseResp,proto3" json:"base_resp,omitempty" form:"base_resp" query:"base_resp"`
	VideoList []*Video  `protobuf:"bytes,2,rep,name=video_list,json=videoList,proto3" json:"video_list,omitempty" form:"video_list" query:"video_list"` // 用户发布的视频列表
}
...
type DouyinFavoriteListResponse struct {
	...
	BaseResp  *BaseResp `protobuf:"bytes,1,opt,name=base_resp,json=baseResp,proto3" json:"base_resp,omitempty" form:"base_resp" query:"base_resp"`
	VideoList []*Video  `protobuf:"bytes,2,rep,name=video_list,json=videoList,proto3" json:"video_list,omitempty" form:"video_list" query:"video_list"` // 用户点赞视频列表
}
...
type DouyinCommentListResponse struct {
	...
	BaseResp    *BaseResp  `protobuf:"bytes,1,opt,name=base_resp,json=baseResp,proto3" json:"base_resp,omitempty" form:"base_resp" query:"base_resp"`
	CommentList []*Comment `protobuf:"bytes,2,rep,name=comment_list,json=commentList,proto3" json:"comment_list,omitempty" form:"comment_list" query:"comment_list"` // 评论列表
}
...
type DouyinRelationFollowListResponse struct {
	...
	BaseResp *BaseResp `protobuf:"bytes,1,opt,name=base_resp,json=baseResp,proto3" json:"base_resp,omitempty" form:"base_resp" query:"base_resp"`
	UserList []*User   `protobuf:"bytes,2,rep,name=user_list,json=userList,proto3" json:"user_list,omitempty" form:"user_list" query:"user_list"` // 用户信息列表
}
...
func (x *DouyinRelationFollowerListRequest) Reset() {
	*x = DouyinRelationFollowerListRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ApiServer_proto_msgTypes[30]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinRelationFollowerListRequest) Descriptor() ([]byte, []int) {
	return file_ApiServer_proto_rawDescGZIP(), []int{30}
}
...
type DouyinRelationFollowerListResponse struct {
	...
	BaseResp *BaseResp `protobuf:"bytes,1,opt,name=base_resp,json=baseResp,proto3" json:"base_resp,omitempty" form:"base_resp" query:"base_resp"`
	UserList []*User   `protobuf:"bytes,2,rep,name=user_list,json=userList,proto3" json:"user_list,omitempty" form:"user_list" query:"user_list"` // 用户列表
}

func (x *DouyinRelationFollowerListResponse) Reset() {
	*x = DouyinRelationFollowerListResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ApiServer_proto_msgTypes[31]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinRelationFollowerListResponse) Descriptor() ([]byte, []int) {
	return file_ApiServer_proto_rawDescGZIP(), []int{31}
}
...
func (x *DouyinRelationFriendListRequest) Reset() {
	*x = DouyinRelationFriendListRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ApiServer_proto_msgTypes[32]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinRelationFriendListRequest) Descriptor() ([]byte, []int) {
	return file_ApiServer_proto_rawDescGZIP(), []int{32}
}
...
type DouyinRelationFriendListResponse struct {
	...
	BaseResp *BaseResp     `protobuf:"bytes,1,opt,name=base_resp,json=baseResp,proto3" json:"base_resp,omitempty" form:"base_resp" query:"base_resp"`
	UserList []*FriendUser `protobuf:"bytes,2,rep,name=user_list,json=userList,proto3" json:"user_list,omitempty" form:"user_list" query:"user_list"` // 好友列表
}

func (x *DouyinRelationFriendListResponse) Reset() {
	*x = DouyinRelationFriendListResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ApiServer_proto_msgTypes[33]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinRelationFriendListResponse) Descriptor() ([]byte, []int) {
	return file_ApiServer_proto_rawDescGZIP(), []int{33}
}

func (x *DouyinRelationFriendListResponse) GetBaseResp() *BaseResp {
	if x != nil {
		return x.BaseResp
	}
	return nil
...
type DouyinMessageChatRequest struct {
	...
	Token      string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty" query:"token"`                                                           // 用户鉴权token
	ToUserId   int64  `protobuf:"varint,2,opt,name=to_user_id,json=toUserId,proto3" json:"to_user_id,omitempty" query:"to_user_id"`                             // 对方用户id
...
func (x *DouyinMessageChatRequest) Reset() {
	*x = DouyinMessageChatRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ApiServer_proto_msgTypes[34]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinMessageChatRequest) Descriptor() ([]byte, []int) {
	return file_ApiServer_proto_rawDescGZIP(), []int{34}
}
...
type DouyinMessageChatResponse struct {
	...
	BaseResp *BaseResp      `protobuf:"bytes,1,opt,name=base_resp,json=baseResp,proto3" json:"base_resp,omitempty" form:"base_resp" query:"base_resp"`
	ChatList []*ChatMessage `protobuf:"bytes,2,rep,name=chat_list,json=chatList,proto3" json:"chat_list,omitempty" form:"chat_list" query:"chat_list"` // 聊天消息列表
}

func (x *DouyinMessageChatResponse) Reset() {
	*x = DouyinMessageChatResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ApiServer_proto_msgTypes[35]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinMessageChatResponse) Descriptor() ([]byte, []int) {
	return file_ApiServer_proto_rawDescGZIP(), []int{35}
}
...
type DouyinMessageActionRequest struct {
	...
	Token      string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty" query:"token"`                                    // 用户鉴权token
	ToUserId   int64  `protobuf:"varint,2,opt,name=to_user_id,json=toUserId,proto3" json:"to_user_id,omitempty" query:"to_user_id"`      // 对方用户id
	ActionType int32  `protobuf:"varint,3,opt,name=action_type,json=actionType,proto3" json:"action_type,omitempty" query:"action_type"` // 1-发送消息，2-删除消息
	Content    string `protobuf:"bytes,4,opt,name=content,proto3" json:"content,omitempty" query:"content" vd:"len($) > 0"`              // 用户填写的消息内容，在action_type=1的时候使用
}

func (x *DouyinMessageActionRequest) Reset() {
	*x = DouyinMessageActionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ApiServer_proto_msgTypes[36]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinMessageActionRequest) Descriptor() ([]byte, []int) {
	return file_ApiServer_proto_rawDescGZIP(), []int{36}
}
...
func (x *DouyinMessageActionResponse) Reset() {
	*x = DouyinMessageActionResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ApiServer_proto_msgTypes[37]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinMessageActionResponse) Descriptor() ([]byte, []int) {
	return file_ApiServer_proto_rawDescGZIP(), []int{37}
}
...
var file_ApiServer_proto_rawDesc = []byte{
	...
	0x44, 0x61, 0x74, 0x65, 0x22, 0xcb, 0x01, 0x0a, 0x0a, 0x46, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x55,
	...
	0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x69, 0x73, 0x46, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x12, 0x18,
	...
	0x79, 0x70, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x6d, 0x73, 0x67, 0x54, 0x79,
	0x70, 0x65, 0x22, 0xad, 0x01, 0x0a, 0x0b, 0x43, 0x68, 0x61, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61,
	...
	0x6d, 0x65, 0x22, 0x4a, 0x0a, 0x08, 0x42, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70, 0x12, 0x1f,
	...
	,
	...
	0x0b, 0x32, 0x10, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x56, 0x69,
	0x64, 0x65, 0x6f, 0x52, 0x09, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x1b,
	0x0a, 0x09, 0x6e, 0x65, 0x78, 0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x08, 0x6e, 0x65, 0x78, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x8f, 0x01, 0x0a, 0x19,
	...
	0x20, 0x33, 0x32, 0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x7d, 0x0a,
	...
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x8c, 0x01, 0x0a,
	...
	0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x1c, 0xb2, 0xbb, 0x18, 0x08, 0x75,
	0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0xda, 0xbb, 0x18, 0x0c, 0x6c, 0x65, 0x6e, 0x28, 0x24,
	0x29, 0x20, 0x3c, 0x3d, 0x20, 0x33, 0x32, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d,
	0x65, 0x12, 0x38, 0x0a, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x42, 0x1c, 0xb2, 0xbb, 0x18, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72,
	0x64, 0xda, 0xbb, 0x18, 0x0c, 0x6c, 0x65, 0x6e, 0x28, 0x24, 0x29, 0x20, 0x3c, 0x3d, 0x20, 0x33,
	0x32, 0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x7a, 0x0a, 0x17, 0x44,
	...
	0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x5a, 0x0a, 0x11, 0x44, 0x6f, 0x75, 0x79, 0x69,
	0x6e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x24, 0x0a, 0x07,
	...
	0x6b, 0x65, 0x6e, 0x22, 0x6b, 0x0a, 0x12, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x55, 0x73, 0x65,
	0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x30, 0x0a, 0x09, 0x62, 0x61, 0x73,
	...
	0x22, 0x98, 0x01, 0x0a, 0x1a, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x50, 0x75, 0x62, 0x6c, 0x69,
	...
	,
	...
	0x73, 0x70, 0x52, 0x08, 0x62, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70, 0x22, 0x61, 0x0a, 0x18,
	...
	0x7e, 0x0a, 0x19, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68,
	...
	0x28, 0x0b, 0x32, 0x10, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x56,
	0x69, 0x64, 0x65, 0x6f, 0x52, 0x09, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x22,
	0x99, 0x01, 0x0a, 0x1b, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69,
	...
	0x0a, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x22, 0x50, 0x0a, 0x1c, 0x44,
	...
	0x61, 0x73, 0x65, 0x5f, 0x72, 0x65, 0x73, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13,
	0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x42, 0x61, 0x73, 0x65, 0x52,
	0x65, 0x73, 0x70, 0x52, 0x08, 0x62, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70, 0x22, 0x62, 0x0a,
	0x19, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x4c,
	...
	,
	...
	,
	...
	0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e,
	0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e,
	0x74, 0x52, 0x07, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x22, 0x64, 0x0a, 0x18, 0x44, 0x6f,
	...
	0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x27, 0x0a, 0x08, 0x76, 0x69, 0x64, 0x65, 0x6f,
	0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x42, 0x0c, 0xb2, 0xbb, 0x18, 0x08, 0x76,
	0x69, 0x64, 0x65, 0x6f, 0x5f, 0x69, 0x64, 0x52, 0x07, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x49, 0x64,
	0x22, 0x84, 0x01, 0x0a, 0x19, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x43, 0x6f, 0x6d, 0x6d, 0x65,
	...
	0x12, 0x35, 0x0a, 0x0c, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x6c, 0x69, 0x73, 0x74,
	0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x0b, 0x63, 0x6f, 0x6d, 0x6d,
	0x65, 0x6e, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x22, 0xba, 0x01, 0x0a, 0x1b, 0x44, 0x6f, 0x75, 0x79,
	...
	,
	...
	0x73, 0x65, 0x52, 0x65, 0x73, 0x70, 0x22, 0x68, 0x0a, 0x1f, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e,
	...
	,
	...
	0x12, 0x1f, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42,
	0x09, 0xb2, 0xbb, 0x18, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65,
	0x6e, 0x22, 0x84, 0x01, 0x0a, 0x22, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x52, 0x65, 0x6c, 0x61,
	...
	0x52, 0x08, 0x62, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70, 0x12, 0x2c, 0x0a, 0x09, 0x75, 0x73,
	0x65, 0x72, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0f, 0x2e,
	0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x08,
	0x75, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x68, 0x0a, 0x1f, 0x44, 0x6f, 0x75, 0x79,
	...
	0x42, 0x09, 0xb2, 0xbb, 0x18, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x05, 0x74, 0x6f, 0x6b,
	0x65, 0x6e, 0x22, 0x88, 0x01, 0x0a, 0x20, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x52, 0x65, 0x6c,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x27, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x2e, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74,
	...
	0x6f, 0x72, 0x69, 0x74, 0x65, 0x2f, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x12, 0x79, 0x0a,
	0x0c, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x24, 0x2e,
	...
	,
	...
	0x69, 0x6f, 0x6e, 0x2f, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x12, 0x90, 0x01, 0x0a, 0x12,
	0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x46, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x4c, 0x69,
	0x73, 0x74, 0x12, 0x2a, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x44,
	0x6f, 0x75, 0x79, 0x69, 0x6e, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x46, 0x6f, 0x6c,
	0x6c, 0x6f, 0x77, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2b,
	0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x44, 0x6f, 0x75, 0x79, 0x69,
	...
	,
	...
	0x66, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x2f, 0x6c, 0x69, 0x73, 0x74, 0x2f, 0x12, 0x73, 0x0a, 0x0b,
	0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x43, 0x68, 0x61, 0x74, 0x12, 0x23, 0x2e, 0x41, 0x70,
	0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x4d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x43, 0x68, 0x61, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x24, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x44, 0x6f, 0x75,
	...
	,
}
...
var file_ApiServer_proto_msgTypes = make([]protoimpl.MessageInfo, 38)
var file_ApiServer_proto_goTypes = []interface{}{
	...
	(*FriendUser)(nil),                         // 3: ApiServer.FriendUser
	(*ChatMessage)(nil),                        // 4: ApiServer.ChatMessage
	(*BaseResp)(nil),                           // 5: ApiServer.BaseResp
	(*DouyinFeedRequest)(nil),                  // 6: ApiServer.DouyinFeedRequest
	(*DouyinFeedResponse)(nil),                 // 7: ApiServer.DouyinFeedResponse
	(*DouyinUserRegisterRequest)(nil),          // 8: ApiServer.DouyinUserRegisterRequest
	(*DouyinUserRegisterResponse)(nil),         // 9: ApiServer.DouyinUserRegisterResponse
	(*DouyinUserLoginRequest)(nil),             // 10: ApiServer.DouyinUserLoginRequest
	(*DouyinUserLoginResponse)(nil),            // 11: ApiServer.DouyinUserLoginResponse
	(*DouyinUserRequest)(nil),                  // 12: ApiServer.DouyinUserRequest
	(*DouyinUserResponse)(nil),                 // 13: ApiServer.DouyinUserResponse
	(*DouyinPublishActionRequest)(nil),         // 14: ApiServer.DouyinPublishActionRequest
	(*DouyinPublishActionResponse)(nil),        // 15: ApiServer.DouyinPublishActionResponse
	(*DouyinPublishListRequest)(nil),           // 16: ApiServer.DouyinPublishListRequest
	(*DouyinPublishListResponse)(nil),          // 17: ApiServer.DouyinPublishListResponse
	(*DouyinFavoriteActionRequest)(nil),        // 18: ApiServer.DouyinFavoriteActionRequest
	(*DouyinFavoriteActionResponse)(nil),       // 19: ApiServer.DouyinFavoriteActionResponse
	(*DouyinFavoriteListRequest)(nil),          // 20: ApiServer.DouyinFavoriteListRequest
	(*DouyinFavoriteListResponse)(nil),         // 21: ApiServer.DouyinFavoriteListResponse
	(*DouyinCommentActionRequest)(nil),         // 22: ApiServer.DouyinCommentActionRequest
	(*DouyinCommentActionResponse)(nil),        // 23: ApiServer.DouyinCommentActionResponse
	(*DouyinCommentListRequest)(nil),           // 24: ApiServer.DouyinCommentListRequest
	(*DouyinCommentListResponse)(nil),          // 25: ApiServer.DouyinCommentListResponse
	(*DouyinRelationActionRequest)(nil),        // 26: ApiServer.DouyinRelationActionRequest
	(*DouyinRelationActionResponse)(nil),       // 27: ApiServer.DouyinRelationActionResponse
	(*DouyinRelationFollowListRequest)(nil),    // 28: ApiServer.DouyinRelationFollowListRequest
	(*DouyinRelationFollowListResponse)(nil),   // 29: ApiServer.DouyinRelationFollowListResponse
	(*DouyinRelationFollowerListRequest)(nil),  // 30: ApiServer.DouyinRelationFollowerListRequest
	(*DouyinRelationFollowerListResponse)(nil), // 31: ApiServer.DouyinRelationFollowerListResponse
	(*DouyinRelationFriendListRequest)(nil),    // 32: ApiServer.DouyinRelationFriendListRequest
	(*DouyinRelationFriendListResponse)(nil),   // 33: ApiServer.DouyinRelationFriendListResponse
	(*DouyinMessageChatRequest)(nil),           // 34: ApiServer.DouyinMessageChatRequest
	(*DouyinMessageChatResponse)(nil),          // 35: ApiServer.DouyinMessageChatResponse
	(*DouyinMessageActionRequest)(nil),         // 36: ApiServer.DouyinMessageActionRequest
	(*DouyinMessageActionResponse)(nil),        // 37: ApiServer.DouyinMessageActionResponse
}
var file_ApiServer_proto_depIdxs = []int32{
	...
	5,  // 2: ApiServer.DouyinFeedResponse.base_resp:type_name -> ApiServer.BaseResp
	1,  // 3: ApiServer.DouyinFeedResponse.video_list:type_name -> ApiServer.Video
	5,  // 4: ApiServer.DouyinUserRegisterResponse.base_resp:type_name -> ApiServer.BaseResp
	5,  // 5: ApiServer.DouyinUserLoginResponse.base_resp:type_name -> ApiServer.BaseResp
	5,  // 6: ApiServer.DouyinUserResponse.base_resp:type_name -> ApiServer.BaseResp
	0,  // 7: ApiServer.DouyinUserResponse.user:type_name -> ApiServer.User
	5,  // 8: ApiServer.DouyinPublishActionResponse.base_resp:type_name -> ApiServer.BaseResp
	5,  // 9: ApiServer.DouyinPublishListResponse.base_resp:type_name -> ApiServer.BaseResp
	1,  // 10: ApiServer.DouyinPublishListResponse.video_list:type_name -> ApiServer.Video
	5,  // 11: ApiServer.DouyinFavoriteActionResponse.base_resp:type_name -> ApiServer.BaseResp
	5,  // 12: ApiServer.DouyinFavoriteListResponse.base_resp:type_name -> ApiServer.BaseResp
	1,  // 13: ApiServer.DouyinFavoriteListResponse.video_list:type_name -> ApiServer.Video
	5,  // 14: ApiServer.DouyinCommentActionResponse.base_resp:type_name -> ApiServer.BaseResp
	2,  // 15: ApiServer.DouyinCommentActionResponse.comment:type_name -> ApiServer.Comment
	5,  // 16: ApiServer.DouyinCommentListResponse.base_resp:type_name -> ApiServer.BaseResp
	2,  // 17: ApiServer.DouyinCommentListResponse.comment_list:type_name -> ApiServer.Comment
	5,  // 18: ApiServer.DouyinRelationActionResponse.base_resp:type_name -> ApiServer.BaseResp
	5,  // 19: ApiServer.DouyinRelationFollowListResponse.base_resp:type_name -> ApiServer.BaseResp
	0,  // 20: ApiServer.DouyinRelationFollowListResponse.user_list:type_name -> ApiServer.User
	5,  // 21: ApiServer.DouyinRelationFollowerListResponse.base_resp:type_name -> ApiServer.BaseResp
	0,  // 22: ApiServer.DouyinRelationFollowerListResponse.user_list:type_name -> ApiServer.User
	5,  // 23: ApiServer.DouyinRelationFriendListResponse.base_resp:type_name -> ApiServer.BaseResp
	3,  // 24: ApiServer.DouyinRelationFriendListResponse.user_list:type_name -> ApiServer.FriendUser
	5,  // 25: ApiServer.DouyinMessageChatResponse.base_resp:type_name -> ApiServer.BaseResp
	4,  // 26: ApiServer.DouyinMessageChatResponse.chat_list:type_name -> ApiServer.ChatMessage
	5,  // 27: ApiServer.DouyinMessageActionResponse.base_resp:type_name -> ApiServer.BaseResp
	8,  // 28: ApiServer.ApiService.Register:input_type -> ApiServer.DouyinUserRegisterRequest
	10, // 29: ApiServer.ApiService.Login:input_type -> ApiServer.DouyinUserLoginRequest
	12, // 30: ApiServer.ApiService.GetUserInfo:input_type -> ApiServer.DouyinUserRequest
	6,  // 31: ApiServer.ApiService.Feed:input_type -> ApiServer.DouyinFeedRequest
	14, // 32: ApiServer.ApiService.PublishAction:input_type -> ApiServer.DouyinPublishActionRequest
	16, // 33: ApiServer.ApiService.PublishList:input_type -> ApiServer.DouyinPublishListRequest
	18, // 34: ApiServer.ApiService.FavoriteAction:input_type -> ApiServer.DouyinFavoriteActionRequest
	20, // 35: ApiServer.ApiService.FavoriteList:input_type -> ApiServer.DouyinFavoriteListRequest
	22, // 36: ApiServer.ApiService.CommentAction:input_type -> ApiServer.DouyinCommentActionRequest
	24, // 37: ApiServer.ApiService.CommentList:input_type -> ApiServer.DouyinCommentListRequest
	26, // 38: ApiServer.ApiService.RelationAction:input_type -> ApiServer.DouyinRelationActionRequest
	28, // 39: ApiServer.ApiService.RelationFollowList:input_type -> ApiServer.DouyinRelationFollowListRequest
	30, // 40: ApiServer.ApiService.RelationFollowerList:input_type -> ApiServer.DouyinRelationFollowerListRequest
	32, // 41: ApiServer.ApiService.RelationFriendList:input_type -> ApiServer.DouyinRelationFriendListRequest
	34, // 42: ApiServer.ApiService.MessageChat:input_type -> ApiServer.DouyinMessageChatRequest
	36, // 43: ApiServer.ApiService.MessageAction:input_type -> ApiServer.DouyinMessageActionRequest
	9,  // 44: ApiServer.ApiService.Register:output_type -> ApiServer.DouyinUserRegisterResponse
	11, // 45: ApiServer.ApiService.Login:output_type -> ApiServer.DouyinUserLoginResponse
	13, // 46: ApiServer.ApiService.GetUserInfo:output_type -> ApiServer.DouyinUserResponse
	7,  // 47: ApiServer.ApiService.Feed:output_type -> ApiServer.DouyinFeedResponse
	15, // 48: ApiServer.ApiService.PublishAction:output_type -> ApiServer.DouyinPublishActionResponse
	17, // 49: ApiServer.ApiService.PublishList:output_type -> ApiServer.DouyinPublishListResponse
	19, // 50: ApiServer.ApiService.FavoriteAction:output_type -> ApiServer.DouyinFavoriteActionResponse
	19, // 51: ApiServer.ApiService.FavoriteList:output_type -> ApiServer.DouyinFavoriteActionResponse
	23, // 52: ApiServer.ApiService.CommentAction:output_type -> ApiServer.DouyinCommentActionResponse
	25, // 53: ApiServer.ApiService.CommentList:output_type -> ApiServer.DouyinCommentListResponse
	27, // 54: ApiServer.ApiService.RelationAction:output_type -> ApiServer.DouyinRelationActionResponse
	29, // 55: ApiServer.ApiService.RelationFollowList:output_type -> ApiServer.DouyinRelationFollowListResponse
	31, // 56: ApiServer.ApiService.RelationFollowerList:output_type -> ApiServer.DouyinRelationFollowerListResponse
	33, // 57: ApiServer.ApiService.RelationFriendList:output_type -> ApiServer.DouyinRelationFriendListResponse
	35, // 58: ApiServer.ApiService.MessageChat:output_type -> ApiServer.DouyinMessageChatResponse
	37, // 59: ApiServer.ApiService.MessageAction:output_type -> ApiServer.DouyinMessageActionResponse
...
func file_ApiServer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_ApiServer_proto_msgTypes[30].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ApiServer_proto_msgTypes[31].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ApiServer_proto_msgTypes[32].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ApiServer_proto_msgTypes[33].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ApiServer_proto_msgTypes[34].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ApiServer_proto_msgTypes[35].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ApiServer_proto_msgTypes[36].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ApiServer_proto_msgTypes[37].Exporter = func(v interface{}, i int) interface{} {
	...
	file_ApiServer_proto_msgTypes[4].OneofWrappers = []interface{}{}
	type x struct{}
